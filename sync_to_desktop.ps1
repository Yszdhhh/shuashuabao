...
#     -ManifestSigningKeyPath <仓外私钥> -ManifestSigningKeyId <key-id> `
#     -ManifestPublicKeysPath <仓外公钥 registry>
...
$signing = @()
if ($ManifestSigningKeyPath.Trim()) { $signing += @("-ManifestSigningKeyPath", $ManifestSigningKeyPath) }
if ($ManifestSigningKeyId.Trim()) { $signing += @("-ManifestSigningKeyId", $ManifestSigningKeyId) }
if ($ManifestPublicKeysPath.Trim()) { $signing += @("-ManifestPublicKeysPath", $ManifestPublicKeysPath) }
