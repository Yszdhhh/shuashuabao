...
class C2InGameStateIsolation(unittest.TestCase):
    ...
    INGAME_POLLUTION = {
        ...
        "_merchant_urgent_next_at": 1.0e9,
        "_advanced_groups_completed": 5,
        "_l1_cycle_resume": (3, "skill"),
        ...
        "_hitch_pregame_transition_since": 1.0e9,
        "_hitch_unstarted_exit_esc_attempts": 1,
        "_hitch_archaeology_room_pending": True,
        "_hitch_archaeology_check_next_at": 1.0e9,
        "_hitch_stats_stages": {"9-9": 3},
        "_hitch_stats_current_stage": "9-9",
        "_hitch_stats_current_challenges": ["污染挑战"],
        "_hitch_pending_selected_stage": "9-9",
        "_hitch_stats_stage_recorded_this_round": True,
        ...
        "_battle_view_home": (0.9, 0.9),
        "_battle_view_home_candidate": (0.9, 0.9),
        "_battle_view_home_since": 1.0e9,
        "_battle_view_home_frames": 99,
        "_battle_view_away_since": 1.0e9,
        "_battle_view_last_frame": object(),
        "_battle_view_f2_count": 3,
        "_battle_view_f2_next_at": 1.0e9,
