...
from gamescript.shell.mode_catalog import apply_mode_overlay, desktop_may_start
from gamescript.shell.runtime_status import (
    RUNNER_IDLE,
    RUNNER_RUNNING,
    RUNNER_STARTING,
    RUNNER_STOPPING,
...
class RunnerService:
    ...
    def start(self, mode_id: str, settings_snapshot: Settings) -> MediatorWorker:
        ...
        self._started_settings = snapshot
